...
/* harmony import */ var _actionCreators__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./actionCreators */ "./resources/js/actions/gallery/actionCreators.js");


var errorFetch = function errorFetch() {
  return function (dispatch) {
    setTimeout(function () {
      return dispatch(Object(_actionCreators__WEBPACK_IMPORTED_MODULE_1__["fetchGalleryListHasErrored"])(true));
    }, 5000);
  };
};
var fetchGalleryList = function fetchGalleryList(url) {
  return function (dispatch) {
    dispatch(Object(_actionCreators__WEBPACK_IMPORTED_MODULE_1__["galleryIsLoading"])(true));
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url).then(function (response) {
      if (!response.ok) {
        throw Error(response.statusText);
      }

      dispatch(Object(_actionCreators__WEBPACK_IMPORTED_MODULE_1__["galleryIsLoading"])(false));
      return response;
    }).then(function (response) {
      return response.json();
    }).then(function (data) {
      return dispatch(Object(_actionCreators__WEBPACK_IMPORTED_MODULE_1__["fetchGalleryListSuccess"])(data));
    }).catch(function () {
      return dispatch(Object(_actionCreators__WEBPACK_IMPORTED_MODULE_1__["fetchGalleryListHasErrored"])(true));
    });
  };
...
var Gallery = Object(react__WEBPACK_IMPORTED_MODULE_0__["memo"])(function (props) {
